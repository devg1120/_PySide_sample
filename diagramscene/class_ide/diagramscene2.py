...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def __init__(self):
        ...
        self.view.setSceneRect(QtCore.QRectF(0, 0, 600, 600))
        ...
        #proxyParent = QtWidgets.QGraphicsRectItem(QtCore.QRectF(0, 0, 100, 100))
        #proxyParent.setFlag(QtWidgets.QGraphicsItem.ItemIsMovable, True);
        #proxyParent.setFlag(QtWidgets.QGraphicsItem.ItemIsSelectable, True);
        #proxyParent.setPos(300, 30);
        #self.scene.addItem(proxyParent);

        #tableProxy = QtWidgets.QGraphicsProxyWidget()
        #tableProxy.setWidget(table_widget);
        #tableProxy.setParentItem(proxyParent);
        
        #tableProxy = QtWidgets.QGraphicsProxyWidget()
        #tableProxy.setFlag(QtWidgets.QGraphicsItem.ItemIsMovable, True)
        #tableProxy.setFlag(QtWidgets.QGraphicsItem.ItemIsSelectable, True)
        #tableProxy.setWidget(table_widget);
