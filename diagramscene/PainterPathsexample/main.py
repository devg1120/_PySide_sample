...
class Window(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        panelLayout.addWidget(self.fillToLabel           , 1, 2)
        panelLayout.addWidget(self.fillColor2ComboBox    , 1, 3)
        panelLayout.addWidget(self.penWidthLabel         , 2, 0)
        panelLayout.addWidget(self.penWidthSpinBox       , 2, 1, 1, 3)
        panelLayout.addWidget(self.penColorLabel         , 3, 0)
        panelLayout.addWidget(self.penColorComboBox      , 3, 1, 1, 3)
        panelLayout.addWidget(self.rotationAngleLabel    , 4, 0)
        panelLayout.addWidget(self.rotationAngleSpinBox  , 4, 1, 1, 3)
...
class RenderArea(QWidget):
    ...
    def __init__(self, paths, name, parent=None):
        super().__init__(parent)
