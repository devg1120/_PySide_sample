...
class Connector(QtWidgets.QGraphicsPathItem):
    ...
    def updatePosition(self):
        ...
        #path.moveTo(self.myStartItem.x() + self.myStartItem._x + self.myStartItem._width, self.myStartItem.y() )
        #path.lineTo(self.myStartItem.x() + xd/2, self.myStartItem.y() )
        #path.lineTo(self.myEndItem.x() + xd/2, self.myEndItem.y())
        #path.lineTo(self.myEndItem.x(), self.myEndItem.y())
