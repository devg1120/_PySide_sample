...
_elements2 = [{ 'group':'nodes', 'position': {'x': 0, 'y': 0}, 'data':{ 'id': 'n0' ,'label' :'n0'   }},
              { 'group':'nodes', 'position': {'x': 0, 'y': 0}, 'data':{ 'id': 'n1' ,'label': 'n1'   }},
              { 'group':'nodes', 'position': {'x': 0, 'y': 0}, 'data':{ 'id': 'n2' ,'label': 'n2'   }},
              { 'group':'nodes', 'position': {'x': 0, 'y': 0}, 'data':{ 'id': 'n3' ,'label': 'n3'   }},
              { 'group':'nodes', 'position': {'x': 0, 'y': 0}, 'data':{ 'id': 'n4' ,'label': 'n4'   , 'parent': 'n37'}},
              { 'group':'nodes', 'position': {'x': 0, 'y': 0}, 'data':{ 'id': 'n5' ,'label': 'n5'   }},
              { 'group':'nodes', 'position': {'x': 0, 'y': 0}, 'data':{ 'id': 'n6' ,'label': 'n6'   }},
              { 'group':'nodes', 'position': {'x': 0, 'y': 0}, 'data':{ 'id': 'n7' ,'label': 'n7'   , 'parent': 'n37'}},
              { 'group':'nodes', 'position': {'x': 0, 'y': 0}, 'data':{ 'id': 'n8' ,'label': 'n8'   , 'parent': 'n37'}},
              { 'group':'nodes', 'position': {'x': 0, 'y': 0}, 'data':{ 'id': 'n9' ,'label': 'n9'   , 'parent': 'n37'}},
              { 'group':'nodes', 'position': {'x': 0, 'y': 0}, 'data':{ 'id': 'n10','label': 'n10'  , 'parent': 'n38'}},
              { 'group':'nodes', 'position': {'x': 0, 'y': 0}, 'data':{ 'id': 'n12','label': 'n12'  }},
              { 'group':'nodes', 'position': {'x': 0, 'y': 0}, 'data':{ 'id': 'n13','label': 'n13'  }},
              { 'group':'nodes', 'position': {'x': 0, 'y': 0}, 'data':{ 'id': 'n14','label': 'n14'  }},
              { 'group':'nodes', 'position': {'x': 0, 'y': 0}, 'data':{ 'id': 'n15','label': 'n15'  }},
              { 'group':'nodes', 'position': {'x': 0, 'y': 0}, 'data':{ 'id': 'n16','label': 'n16'  }},
              { 'group':'nodes', 'position': {'x': 0, 'y': 0}, 'data':{ 'id': 'n17','label': 'n17'  }},
              { 'group':'nodes', 'position': {'x': 0, 'y': 0}, 'data':{ 'id': 'n18','label': 'n18'  }},
              { 'group':'nodes', 'position': {'x': 0, 'y': 0}, 'data':{ 'id': 'n19','label': 'n19'  }},
              { 'group':'nodes', 'position': {'x': 0, 'y': 0}, 'data':{ 'id': 'n20','label': 'n20'  }},
              { 'group':'nodes', 'position': {'x': 0, 'y': 0}, 'data':{ 'id': 'n21','label': 'n21'  }},
              { 'group':'nodes', 'position': {'x': 0, 'y': 0}, 'data':{ 'id': 'n22','label': 'n22'  }},
              { 'group':'nodes', 'position': {'x': 0, 'y': 0}, 'data':{ 'id': 'n23','label': 'n23'  }},
              { 'group':'nodes', 'position': {'x': 0, 'y': 0}, 'data':{ 'id': 'n24','label': 'n24'  , 'parent': 'n39'}},
              { 'group':'nodes', 'position': {'x': 0, 'y': 0}, 'data':{ 'id': 'n25','label': 'n25'  , 'parent': 'n39'}},
              { 'group':'nodes', 'position': {'x': 0, 'y': 0}, 'data':{ 'id': 'n26','label': 'n26'  , 'parent': 'n42'}},
              { 'group':'nodes', 'position': {'x': 0, 'y': 0}, 'data':{ 'id': 'n27','label': 'n27'  , 'parent': 'n42'}},
              { 'group':'nodes', 'position': {'x': 0, 'y': 0}, 'data':{ 'id': 'n28','label': 'n28'  , 'parent': 'n42'}},
              { 'group':'nodes', 'position': {'x': 0, 'y': 0}, 'data':{ 'id': 'n29','label': 'n29'  , 'parent': 'n40'}},
              { 'group':'nodes', 'position': {'x': 0, 'y': 0}, 'data':{ 'id': 'n31','label': 'n31'  , 'parent': 'n41'}},
              { 'group':'nodes', 'position': {'x': 0, 'y': 0}, 'data':{ 'id': 'n32','label': 'n32'  , 'parent': 'n41'}},
              { 'group':'nodes', 'position': {'x': 0, 'y': 0}, 'data':{ 'id': 'n33','label': 'n33'  , 'parent': 'n41'}},
              { 'group':'nodes', 'position': {'x': 0, 'y': 0}, 'data':{ 'id': 'n34','label': 'n34'  , 'parent': 'n41'}},
              { 'group':'nodes', 'position': {'x': 0, 'y': 0}, 'data':{ 'id': 'n35','label': 'n35'  , 'parent': 'n41'}},
              { 'group':'nodes', 'position': {'x': 0, 'y': 0}, 'data':{ 'id': 'n36','label': 'n36'  , 'parent': 'n41'}},
              { 'group':'nodes', 'position': {'x': 0, 'y': 0}, 'data':{ 'id': 'n37','label': 'n37'  }},
              { 'group':'nodes', 'position': {'x': 0, 'y': 0}, 'data':{ 'id': 'n38','label': 'n38'  }},
              { 'group':'nodes', 'position': {'x': 0, 'y': 0}, 'data':{ 'id': 'n39','label': 'n39'  , 'parent': 'n43'}},
              { 'group':'nodes', 'position': {'x': 0, 'y': 0}, 'data':{ 'id': 'n40','label': 'n40'  , 'parent': 'n42'}},
              { 'group':'nodes', 'position': {'x': 0, 'y': 0}, 'data':{ 'id': 'n41','label': 'n41'  , 'parent': 'n42'}},
              { 'group':'nodes', 'position': {'x': 0, 'y': 0}, 'data':{ 'id': 'n42','label': 'n42'  , 'parent': 'n43'}},
              { 'group':'nodes', 'position': {'x': 0, 'y': 0}, 'data':{ 'id': 'n43','label': 'n43'  },'classes': ['classtest']},
...
# https://community.plotly.com/t/dash-cytoscape-returning-node-positions-from-layout/23818/7
