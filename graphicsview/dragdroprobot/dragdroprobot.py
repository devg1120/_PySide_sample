...
class ColorItem(QtWidgets.QGraphicsItem):
    ...
    def __init__(self):
        ...
        #self.color = QtWidgets.QColor(QtCore.qrand() % 256, QtCore.qrand() % 256,
        #        QtCore.qrand() % 256)
    ...
    def mouseMoveEvent(self, event):
        ...
        if ColorItem.n > 2 and QtCore.QRandomGenerator().global_().bounded(256) % 3 == 0:
...
class RobotPart(QtWidgets.QGraphicsItem):
    def __init__(self, parent=None):
        ...
        #self.color = QtWidgets.QColor(QtCore.Qt.lightGray)
    ...
    def dropEvent(self, event):
        ...
        if event.mimeData().hasColor():
            ...
            self.pixmap = QtWidgets.QPixmap(event.mimeData().imageData())
...
class RobotHead(RobotPart):
    ...
    def paint(self, painter, option, widget=None):
        if not self.pixmap:
            ...
            #painter.setPen(QtWidgets.QPen(QtCore.Qt.black, 2))
